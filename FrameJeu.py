...
class FrameJeu():
    ...
    def affichageMap(self,perso,map):  
        ...
        if self.parent.parent.jeu.listePersonnage:
            ...
            self.map.create_rectangle(temp[0]- perso.posMapX, temp[1]- perso.posMapY, temp[2]- perso.posMapX, temp[3]- perso.posMapY, fill='blue', tags="p")
            self.map.create_image((self.parent.parent.jeu.listePersonnage[0].posMapX - perso.posMapX),((self.parent.parent.jeu.listePersonnage[0].posMapY-32)- perso.posMapY), image=self.pers, tags="p")
